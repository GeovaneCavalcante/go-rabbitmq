...
func (suite *EventDispatcherTestSuit) TestEventDispacher_Register() {
...
func (suite *EventDispatcherTestSuit) TestEventDispacher_Dispatch_WithSameHandler() {
	err := suite.eventDispatcher.Register(suite.event.GetName(), &suite.handler)
	suite.Nil(err)
	suite.Equal(1, len(suite.eventDispatcher.handlers[suite.event.GetName()]))
...
func (suite *EventDispatcherTestSuit) TestEventDispacher_Clear() {
	err := suite.eventDispatcher.Register(suite.event.GetName(), &suite.handler)
	suite.Nil(err)
...
func (suite *EventDispatcherTestSuit) TestEventDispacher_Has() {
	err := suite.eventDispatcher.Register(suite.event.GetName(), &suite.handler)
	suite.Nil(err)
...
func (suite *EventDispatcherTestSuit) TestEventDispacher_Dispatch() {
	eh := &MockHanlder{}
...
func (suite *EventDispatcherTestSuit) TestEventDispacher_Remove() {
	err := suite.eventDispatcher.Register(suite.event.GetName(), &suite.handler)
	suite.Nil(err)
	suite.Equal(1, len(suite.eventDispatcher.handlers[suite.event.GetName()]))
	err = suite.eventDispatcher.Register(suite.event.GetName(), &suite.handler2)
